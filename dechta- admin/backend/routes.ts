...
function broadcastOnboardingRefresh(payload: { entity: "vendor" | "driver" | "manpower"; action: "verified" | "rejected"; id: number }) {
...
export async function registerRoutes(
  ...
  app.get(api.orders.list.path, async (req, res) => {
    ...
    try {
      const user = await authService.getMe(userId);
      const orders = await orderService.listForUser(userId, user.role as "buyer" | "vendor" | "admin");
